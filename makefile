...
ADDITIONS_REDUCER_OBJECTS = src/entities/arg_parser.o src/utils/utils.o src/entities/scheme_additions_reducer.o src/main_additions_reducer.o
...
additions-reducer: $(ADDITIONS_REDUCER_OBJECTS)
	$(CXX) $(FLAGS) $(ADDITIONS_REDUCER_OBJECTS) -o additions_reducer
